...
eval_low_data = []
eval_high_data = []
eval_low_data_name = glob('/kaggle/input/seperate-dataset-for-right-format/puwell/test/low/*.png')
eval_low_data_name.sort()
eval_high_data_name = glob('/kaggle/input/seperate-dataset-for-right-format/puwell/test/high/*.png')
